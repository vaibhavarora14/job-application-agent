...
export default function Privacy() {
  return <main className="legal page-width">
    ...
    <h2>Why we store it</h2><p>To invite founding users, provide purchased access, support refunds or disputes, understand demand, and send product updates. To prevent automated abuse, we temporarily store a pseudonymous identifier derived from a visitor&apos;s network address; the application database does not retain the raw address. We do not sell this information.</p>
