...
export default function Terms() {
  return <main className="legal page-width">
    ...
    <h2>The founding offer</h2><p>The founding offer is one-time $49 globally, with a localized price of ₹3,999 including GST for purchases localized to India, for 90 days of cloud access. Checkout is handled by Dodo Payments. Your purchase is confirmed only after a signed payment notification is verified by our server.</p>
