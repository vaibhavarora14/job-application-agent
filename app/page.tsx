    ...
    <main id="top">
      <header className="hero page-width">
        <div className="hero-copy">
          <p className="eyebrow">A disciplined agent for a less exhausting search</p>
      ...
      <section className="section page-width" id="founding">
        <div className="founding-card">
          <div><p className="eyebrow">Founding cloud access</p><h2>Give your search a steadier rhythm.</h2><p>Pay $49 globally or ₹3,999 including GST in India. Your 90 days begin only when cloud access is activated. If we have not activated you within 60 days of payment, you will be automatically refunded.</p></div>
