...
export default function Privacy() {
  return <main className="legal page-width">
    ...
    <h2>Your choices</h2><p>For access, support, or deletion requests, email <a href="mailto:support@jobappagent.com">support@jobappagent.com</a>. Replies are forwarded through Cloudflare Email Routing to an owner-controlled inbox.</p>
