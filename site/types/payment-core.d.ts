declare module "*/payment-core.mjs" {
  ...
  export function buildCheckoutRequest(input: { productId: string; purchaseId: string; publicSiteUrl: string }): import("dodopayments/resources/checkout-sessions").CheckoutSessionCreateParams;
