...
Sources: [Ashby public postings](https://developers.ashbyhq.com/docs/public-job-posting-api), [Greenhouse Job Board API](https://docs.greenhouse.io/job-board.html), and [Lever postings](https://github.com/lever/postings-api).

## Evidence rules and limits

- Match exact ATS job identifier, canonical destination, and normalized role title. The employer board comes from the already-published URL, never from a company-name guess.
